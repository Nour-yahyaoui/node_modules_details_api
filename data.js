...
// Total modules: 777
// Last updated: 2026-09-02 20:05:14
...
module.exports = [
  ...
  {
    "title": "Fastify Blog",
    "description": "Blog plugin for Fastify with posts, categories, and tags",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-blog'), { });",
    "tags": [
      "fastify",
      "blog",
      "posts",
  ...
  {
    "title": "Fastify Auction",
    "description": "Auction plugin for Fastify with bidding and time management",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-auction'), { });",
    "tags": [
      "fastify",
      "auction",
      "bidding",
  ...
  {
    "title": "Fastify Audio Chat",
    "description": "Audio chat plugin for Fastify with WebRTC and streaming",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-audio-chat'), { });",
    "tags": [
      "fastify",
      "audio",
      "chat",
  ...
  {
    "title": "Fastify Document",
    "description": "Document management plugin for Fastify with versioning and sharing",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-document'), { });",
    "tags": [
      "fastify",
      "document",
      "versioning",
  ...
  {
    "title": "Fastify ETL",
    "description": "ETL plugin for Fastify with extract, transform, load pipelines",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-etl'), { pipelines: ['./etl'] });",
    "tags": [
      "fastify",
      "etl",
      "extract",
  ...
  {
    "title": "Fastify Addon",
    "description": "Addon manager for Fastify with modular features",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-addon'), { addons: ['./addons'] });",
    "tags": [
      "fastify",
      "addon",
      "modular",
  ...
  {
    "title": "Fastify Module",
    "description": "Module loader for Fastify with dependency management",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-module'), { modules: ['./modules'] });",
    "tags": [
      "fastify",
      "module",
      "loader",
  ...
  {
    "title": "Fastify Package",
    "description": "Package manager for Fastify with npm integration",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-package'), { });",
    "tags": [
      "fastify",
      "package",
      "npm",
  ...
  {
    "title": "Fastify Proxy (Advanced)",
    "description": "Advanced proxy with authentication and caching",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-proxy'), { upstream: 'https://api.example.com', auth: 'basic' });",
    "tags": [
      "fastify",
      "proxy",
      "auth",
  ...
  {
    "title": "Fastify Producer",
    "description": "Message producer for Fastify with event publishing",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-producer'), { });",
    "tags": [
      "fastify",
      "producer",
      "message",
  ...
  {
    "title": "Fastify Stats",
    "description": "Statistics plugin for Fastify with real-time stats collection",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-stats'), { });",
    "tags": [
      "fastify",
      "stats",
      "statistics",
  ...
  {
    "title": "Fastify Analytics (Advanced)",
    "description": "Advanced analytics with custom event tracking and dashboards",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-analytics'), { providers: ['google', 'mixpanel'] });",
    "tags": [
      "fastify",
      "analytics",
  ...
  {
    "title": "Fastify AI",
    "description": "AI processing plugin for Fastify with natural language and vision",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-ai'), { });",
    "tags": [
      "fastify",
      "ai",
      "nlp",
  ...
  {
    "title": "Fastify NLP",
    "description": "Natural language processing plugin for Fastify with text analysis",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-nlp'), { });",
    "tags": [
      "fastify",
      "nlp",
      "text",
  ...
  {
    "title": "Fastify Speech",
    "description": "Speech processing plugin for Fastify with text-to-speech and STT",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-speech'), { });",
    "tags": [
      "fastify",
      "speech",
      "tts",
  ...
  {
    "title": "Fastify Theater",
    "description": "Theater ticketing plugin for Fastify with performances",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-theater'), { });",
    "tags": [
      "fastify",
      "theater",
      "ticketing",
  ...
  {
    "title": "Fastify Weather",
    "description": "Weather plugin for Fastify with forecasts and alerts",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-weather'), { });",
    "tags": [
      "fastify",
      "weather",
      "forecasts",
  ...
  {
    "title": "Fastify Logistics",
    "description": "Logistics plugin for Fastify with shipping and delivery",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-logistics'), { });",
    "tags": [
      "fastify",
      "logistics",
      "shipping",
  ...
  {
    "title": "Fastify Inventory",
    "description": "Inventory management plugin for Fastify with stock and warehouses",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-inventory'), { });",
    "tags": [
      "fastify",
      "inventory",
      "stock",
  ...
  {
    "title": "Fastify Tourism",
    "description": "Tourism plugin for Fastify with attractions and tours",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-tourism'), { });",
    "tags": [
      "fastify",
      "tourism",
      "attractions",
  ...
  {
    "title": "Fastify Hospitality",
    "description": "Hospitality plugin for Fastify with hotels and restaurants",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-hospitality'), { });",
    "tags": [
      "fastify",
      "hospitality",
      "hotels",
  ...
  {
    "title": "Fastify Food",
    "description": "Food delivery plugin for Fastify with ordering and delivery",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-food'), { });",
    "tags": [
      "fastify",
      "food",
      "delivery",
  ...
  {
    "title": "Fastify Grocery",
    "description": "Grocery plugin for Fastify with shopping and delivery",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-grocery'), { });",
    "tags": [
      "fastify",
      "grocery",
      "shopping",
  ...
  {
    "title": "Fastify Retail",
    "description": "Retail plugin for Fastify with POS and inventory",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-retail'), { });",
    "tags": [
      "fastify",
      "retail",
      "pos",
  ...
  {
    "title": "Fastify Mall",
    "description": "Mall management plugin for Fastify with stores and directories",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-mall'), { });",
    "tags": [
      "fastify",
      "mall",
      "stores",
  ...
  {
    "title": "Fastify Exchange",
    "description": "Exchange plugin for Fastify with currency and rates",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-exchange'), { });",
    "tags": [
      "fastify",
      "exchange",
      "currency",
  ...
  {
    "title": "Fastify Finance",
    "description": "Finance plugin for Fastify with investments and portfolios",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-finance'), { });",
    "tags": [
      "fastify",
      "finance",
      "investments",
  ...
  {
    "title": "Fastify Accounting",
    "description": "Accounting plugin for Fastify with ledgers and journals",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-accounting'), { });",
    "tags": [
      "fastify",
      "accounting",
      "ledgers",
  ...
  {
    "title": "Fastify Recruitment",
    "description": "Recruitment plugin for Fastify with job postings and applicants",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-recruitment'), { });",
    "tags": [
      "fastify",
      "recruitment",
      "job-postings",
  ...
  {
    "title": "Fastify Registry",
    "description": "Registry plugin for Fastify with asset registration and discovery",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-registry'), { });",
    "tags": [
      "fastify",
      "registry",
      "registration",
  ...
  {
    "title": "Fastify Directory",
    "description": "Directory plugin for Fastify with listings and search",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-directory'), { });",
    "tags": [
      "fastify",
      "directory",
      "listings",
  ...
  {
    "title": "Fastify Index",
    "description": "Indexing plugin for Fastify with searchable indexes",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-index'), { });",
    "tags": [
      "fastify",
      "index",
      "searchable",
  ...
  {
    "title": "Fastify Guide",
    "description": "Guide system for Fastify with step-by-step tutorials",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-guide'), { });",
    "tags": [
      "fastify",
      "guide",
      "tutorials",
  ...
  {
    "title": "Fastify Faq",
    "description": "FAQ plugin for Fastify with categories and questions",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-faq'), { });",
    "tags": [
      "fastify",
      "faq",
      "questions",
  ...
  {
    "title": "Fastify Rating",
    "description": "Rating plugin for Fastify with stars and scores",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-rating'), { });",
    "tags": [
      "fastify",
      "rating",
      "stars",
  ...
  {
    "title": "Fastify Election",
    "description": "Election plugin for Fastify with candidates and ballots",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-election'), { });",
    "tags": [
      "fastify",
      "election",
      "candidates",
  ...
  {
    "title": "Fastify Workspace",
    "description": "Workspace plugin for Fastify with project management",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-workspace'), { });",
    "tags": [
      "fastify",
      "workspace",
      "projects",
  ...
  {
    "title": "Fastify Policy",
    "description": "Policy management plugin for Fastify with rules and enforcement",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-policy'), { });",
    "tags": [
      "fastify",
      "policy",
      "rules",
  ...
  {
    "title": "Fastify Compliance",
    "description": "Compliance plugin for Fastify with regulations and audits",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-compliance'), { });",
    "tags": [
      "fastify",
      "compliance",
      "regulations",
  ...
  {
    "title": "Fastify Audit (Advanced)",
    "description": "Advanced auditing with trails and forensics",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-audit'), { forensics: true, trails: true });",
    "tags": [
      "fastify",
      "audit",
      "trails",
  ...
  {
    "title": "Fastify Notification (Advanced)",
    "description": "Advanced notification system with personalization and analytics",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-notification'), { personalization: true, analytics: true });",
    "tags": [
      "fastify",
      "notification",
      "personalization",
  ...
  {
    "title": "Fastify Marketing",
    "description": "Marketing automation plugin for Fastify with campaigns",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-marketing'), { });",
    "tags": [
      "fastify",
      "marketing",
      "campaigns",
  ...
  {
    "title": "Fastify Real-time",
    "description": "Real-time communication plugin for Fastify with WebSockets",
    "usage": "const fastify = require('fastify')(); fastify.register(require('fastify-real-time'), { });",
    "tags": [
      "fastify",
      "real-time",
      "websocket",
