...
// Total modules: 29
// Last updated: 2026-08-15 23:29:55
...
module.exports = [
  ...
  {
    "title": "Jest",
    "description": "A delightful JavaScript testing framework with built-in assertions, mocking, and test coverage reporting",
  ...
  {
    "title": "Mocha",
    "description": "A feature-rich JavaScript test framework running on Node.js that supports async testing and reporting",
    "usage": "describe('Array', function() { describe('#indexOf()', function() { it('should return -1 when value is not present', function() { assert.equal([1,2,3].indexOf(4), -1); }); }); });",
    "tags": [
      "testing",
      "unit-test",
      "async",
  ...
  {
    "title": "Chai",
    "description": "A BDD assertion library for Node.js and browsers with expect, should, and assert interfaces",
  ...
  {
    "title": "Sinon",
    "description": "A test spy, stub, and mock library for Node.js that helps test components in isolation",
  ...
  {
    "title": "ESLint",
    "description": "A static code analysis tool for identifying and fixing problems in JavaScript and TypeScript code",
  ...
  {
    "title": "Prettier",
    "description": "An opinionated code formatter that supports JavaScript, TypeScript, CSS, and many other languages",
  ...
  {
    "title": "ESBuild",
    "description": "An extremely fast JavaScript bundler that compiles TypeScript and JavaScript to ESM or CJS modules",
  ...
  {
    "title": "Vite",
    "description": "A fast build tool for modern web projects with instant server start and lightning-fast HMR",
  ...
  {
    "title": "Webpack",
    "description": "A powerful module bundler that transforms JavaScript, assets, and CSS into optimized bundles",
