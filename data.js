...
// Total modules: 30
// Last updated: 2026-08-15 22:55:58

module.exports = [
  {
    "title": "Express.js",
    "description": "A minimalist web framework for Node.js that provides robust routing and middleware capabilities for building web applications and APIs",
    "usage": "const express = require('express'); const app = express(); app.get('/', (req, res) => res.send('Hello World')); app.listen(3000);",
    "tags": [
      "web",
      "framework",
      "routing",
  ...
  {
    "title": "Axios",
    "description": "A promise-based HTTP client for making asynchronous requests from Node.js and browsers with automatic JSON transformation",
    "usage": "const axios = require('axios'); axios.get('https://api.github.com/users/nour-yahyaoui').then(res => console.log(res.data));",
    "tags": [
      "http",
      "api",
      "promises",
  ...
  {
    "title": "Mongoose",
    "description": "An elegant MongoDB object modeling tool that provides schema validation, query building, and middleware for Node.js applications",
    "usage": "const mongoose = require('mongoose'); await mongoose.connect('mongodb://localhost:27017/test'); const User = mongoose.model('User', { name: String });",
    "tags": [
      "mongodb",
      "odm",
      "database",
  ...
  {
    "title": "Lodash",
    "description": "A modern JavaScript utility library delivering modularity, performance, and extras for common programming tasks like array and object manipulation",
  ...
  {
    "title": "Winston",
    "description": "A versatile logging library that supports multiple transports, custom log levels, and log formatting for production applications",
    "usage": "const winston = require('winston'); const logger = winston.createLogger({ transports: [new winston.transports.Console()] }); logger.info('Hello');",
    "tags": [
      "logging",
      "debug",
      "console",
